...
const BookCard = ({ book, navigate }) => (
  <div className="bg-[#F5E6D3] p-4 rounded-xl shadow hover:shadow-lg transition flex flex-col min-w-[200px] max-w-[220px]">
    ...
    <p className="text-xs sm:text-yellow-600 mt-1">
...
const Dashboard = () => {
  ...
  return (
    ...
    <div
      className="absolute top-6 right-10 cursor-pointer z-[9999]"
      onClick={() => navigate("/profile")}
      title="Go to Profile"
    >
      <FaUserCircle className="text-4xl text-[#7B3F00] hover:text-[#B67438] transition-colors duration-200" />
    </div>
