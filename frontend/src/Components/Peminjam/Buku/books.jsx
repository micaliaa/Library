...
const Book = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] text-[#7B3F00]">
      <div className="mx-auto px-4 max-w-[1200px]">
        ...
        <form onSubmit={handleSearch} className="flex justify-center mb-10 gap-2">
          <input
            ...
            className="w-full max-w-[400px] px-4 py-2 rounded-full border-2 border-[#7B3F00] focus:outline-none focus:ring-2 focus:ring-[#7B3F00]"
          />
          <button
            type="submit"
              ...
              {row.map((book) => {
                ...
                return (
                  ...
                  >
                    {/* 📗 Gambar Buku */}
                    <img
                      src={`http://localhost:3000/${book.Gambar}`}
                      alt={book.Judul}
