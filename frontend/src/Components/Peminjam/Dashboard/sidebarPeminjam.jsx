         ...
         <div className='flex items-center space-x-0'>
              ...
              <nav className='flex flex-col space-y-4 text-center text-sm px-6 mt-5 border-t-5 border-[#B67438] '>
               ...
               <div className='mt-6 space-y-10'>
                    <a href="#"className="flex items-center  hover:text-[#D29D6A] font-medium"> <FiHome className="w-5 h-5 mr-5" />  Dashboard   </a>
                    ...
                    <a href="#"className="flex items-center  hover:text-[#D29D6A] font-medium">   <FiClock className="w-5 h-5 mr-5" /> Borrowings </a>
                </div>
              </nav>
